...
import os
from IC import IC
from selectInComm_2 import mpCommAI
...
def im(res3):
    ...
    seeds_list = mpCommAI(comm_data, args.n_clusters, args.name, args.nodeNum, args.k, query, args.ratio)
...
if __name__ == "__main__":
    ...
    f = open('sdcn2Result/sdcn_2_' + args.name + '_' + str(args.k) + '.txt', 'w', encoding='utf-8')
    print('k: ' + str(args.k) + '\n')
