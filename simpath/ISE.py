...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', help='CARP instance file', dest='graph_path', default=os.path.dirname(os.path.abspath(__file__)) + '/NetPHY.txt')
    parser.add_argument('-s', help='seed set', dest='seed_path', default=os.path.dirname(os.path.abspath(__file__)) + '/NetPHY_seeds.txt')
    parser.add_argument('-m', help='diffusion model', dest='model', default='LT')
    parser.add_argument('-b', type=int,
                        ...
                        dest='type', default=0)
    parser.add_argument('-t', type=float, help='termination', dest='timeout', default=60)
    parser.add_argument('-r', type=int, help='random seed', dest='random_seed', default=1)
