...
def train_sdcn(dataset):
    res_file = open('commResult/' + args.name + '_p.txt', 'w', encoding='utf-8')
    ...
    for epoch in range(30):
        ...
        # update_interval
            ...
            seeds_list = mpCommAI(comm_data, args.n_clusters, args.name, nodeNum)
